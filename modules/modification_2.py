...
plot_everything(
    ...
    padding=(15, 30),
    invert=True,
    filepath=Path("plots", "alt2_atp_ratio_speck_ldh_combined.png"),
)
plot_everything(
    TAS,
    LDH,
    ...
    padding=(20, 40),
    invert=True,
    filepath=Path("plots", "alt2_msu_ratio_speck_ldh_combined.png"),
)
plot_everything(
    TAS,
    LDH,
    ...
    padding=(20, 40),
    invert=True,
    filepath=Path("plots", "alt2_nigericin_ratio_speck_ldh_combined.png"),
)
